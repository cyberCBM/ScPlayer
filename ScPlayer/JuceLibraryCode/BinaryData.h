...
{
    extern const char*   shuffle_gif;
    const int            shuffle_gifSize = 1402;

    extern const char*   repeat_gif;
    const int            repeat_gifSize = 1002;
